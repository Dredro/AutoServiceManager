...
public class OrderService
{
    ...
    public async Task<(string? Result, string? ErrorMessage)> CreateOrderAsync(OrderDTO command)
    {
        return await _apiClient.PostAsync<OrderDTO, string>(BaseEndpoint, command);
    }
